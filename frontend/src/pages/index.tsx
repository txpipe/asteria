    ...
    <div className="w-full bg-starfield bg-cover bg-center relative">
      <div className="min-h-[calc(100vh-64px)] relative">
        ...
        <div className="min-h-[calc(100vh-64px)] container mx-auto sm pb-[10vh] flex flex-col justify-center text-center">
          ...
          <div className="flex flex-row justify-center items-center mb-[6vh]">
            ...
            <span className="font-inter text-xl text-[#A0A0A0]">By TxPipe</span>
          </div>
          <h2 className="font-dmsans text-2xl text-[#F1E9D9] mb-8 leading-relaxed">
            A <span className="font-dmsans font-semibold">Cardano bot challenge</span> to showcase the<br/>capabilities of the <span className="font-dmsans font-semibold">eUTxO model</span>.
          </h2>
          <div className="text-center">
            <Link href="/how-to-play">
              <button className="font-monocraft text-black bg-[#07F3E6] py-4 px-8 rounded-full text-lg">
                How to play
              </button>
            </Link>
          </div>
      ...
      <div className="container mx-auto sm p-32">
        ...
        <div className="p-20 rounded-[64px] backdrop-blur-xs bg-linear-to-l from-[#FFFFFF0B] border-solid border-[3px] border-[#87FCF6] mb-64">
          <h3 className="font-monocraft text-[#07F3E6] text-4xl mb-6">
            A 2D Space Game
          </h3>
          <p className="font-dmsans text-[#F1E9D9] text-xl leading-relaxed">
        ...
        <div className="flex flex-row justify-center -mx-4">
          {challenges.slice(0, 3).map((challenge, index) =>
            <div key={index} className="mx-4 flex-initial basis-1/3 rounded-2xl backdrop-blur-xs bg-[#14141470] overflow-hidden landing-challenge">
              ...
              <div className="p-8">
                <p className="mb-1 font-dmsans text-[#6F6F6F] text-base truncate">
                  Network | <span className="text-[#F1E9D9] capitalize">{ challenge.network }</span>
                </p>
                <p className="mb-2 font-dmsans text-[#6F6F6F] text-base truncate">
                  Shipyard Policy | <span className="text-[#F1E9D9]">{ challenge.shipyardPolicyId }</span>
                </p>
                <p className="mb-4 font-dmsans font-semibold text-white text-2xl truncate">
                  { challenge.label }
                </p>
                <div className="mb-4 flex flex-row items-center justify-between">
                  <button
                    ...
                    className="font-monocraft text-[#07F3E6] border border-[#07F3E6] bg-transparent py-4 px-6 rounded-full text-lg flex-initial disabled:opacity-50"
                  >
                    Select
                  </button>
                </div>
